...
public class ShaderPostProcessor
...
WindowHandle {
    ...
    public void initializeBlastShader() {
        if (this.shockwaveShader != null) {
            return;
        }
        this.shockwaveShader = new ShockwaveShader(RockstarClient.resourceId("blast_shockwave/data"));
    }

    public void renderBlastShockwave(Matrix4f matrix4f, List<JumpCirclePostProcessor.JumpCircleInstance> list) {
